...
enum class SettingItem {
    ...
    SPONSOR_BLOCK_DEFAULT_STRATEGY, // SponsorBlock 默认策略
    SPONSOR_BLOCK_SPONSOR_STRATEGY,
    SPONSOR_BLOCK_SELFPROMO_STRATEGY,
    SPONSOR_BLOCK_EXCLUSIVE_ACCESS_STRATEGY,
    SPONSOR_BLOCK_INTERACTION_STRATEGY,
    SPONSOR_BLOCK_POI_HIGHLIGHT_STRATEGY,
    SPONSOR_BLOCK_INTRO_STRATEGY,
    SPONSOR_BLOCK_OUTRO_STRATEGY,
    SPONSOR_BLOCK_PREVIEW_STRATEGY,
    SPONSOR_BLOCK_FILLER_STRATEGY,
    SPONSOR_BLOCK_MUSIC_OFFTOPIC_STRATEGY,
